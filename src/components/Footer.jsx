  ...
  return (
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        ...
        {/* Main Footer Content - Logo and Description Only */}
        ...
        {/* Bottom Footer with Copyright, Links and Social Icons */}
        <div className="border-t border-gray-700 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center space-x-6">
              ...
              {/* Social Icons - SOS Expats Style */}
              <div className="flex items-center space-x-3 bg-gradient-to-r from-chiefs-red-500 to-chiefs-gold-500 rounded-full px-4 py-2">
                <a 
