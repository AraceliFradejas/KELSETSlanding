        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mb-10">
          ...
          <div className="md:col-span-4">
            <div className="bg-gradient-to-br from-chiefs-red-500 to-chiefs-gold-500 rounded-3xl p-6 shadow-lg">
              <h4 className="text-xl font-bold mb-4 text-white text-center md:text-left">
                {t.footer.social.follow}
              </h4>
              <p className="text-white/90 text-sm mb-6 text-center md:text-left">
                {t.footer.social.follow === "Follow Us" 
                  ? "Stay connected and be the first to know about our latest innovations"
                  : "Mantente conectado y sé el primero en conocer nuestras últimas innovaciones"
                }
              </p>
              <div className="grid grid-cols-2 md:grid-cols-1 lg:grid-cols-2 gap-3">
                <a 
                  ...
                  aria-label="GitHub"
                >
                  <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-3 flex items-center space-x-3 hover:bg-white/30 hover:scale-105 transition-all duration-300 hover:shadow-lg">
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="group col-span-2 md:col-span-1 lg:col-span-2"
                  aria-label="X/Twitter"
                >
                  <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-3 flex items-center justify-center space-x-3 hover:bg-white/30 hover:scale-105 transition-all duration-300 hover:shadow-lg">
                    <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
